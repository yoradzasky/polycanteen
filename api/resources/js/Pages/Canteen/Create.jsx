...
export default function Create() {
    ...
    const handleSubmit = () => {
        post(route('admin.canteens.store'), {
            onSuccess: () => {
                reset();
                router.visit(route('admin.canteens.index'));
            },
        });
    };
                    ...
                    <div className="p-6 border-b border-gray-100 bg-gray-50/50">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Lengkapi semua informasi di bawah untuk mendaftarkan kantin baru</p>
                            </div>
                        </div>
                    </div>
                                ...
                                {data.karyawan.map((item, index) => (
                                    <div key={index} className="p-5 border-2 border-gray-200 rounded-lg relative bg-white shadow-sm">
                                        ...
                                        <div className="mb-4 flex items-center space-x-2">
                                            ...
                                            <h5 className="text-sm font-semibold text-gray-700">Detail Karyawan</h5>
                                        </div>
