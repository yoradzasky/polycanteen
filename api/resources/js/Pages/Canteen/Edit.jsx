    ...
    return (
                ...
                <div className="flex items-center gap-2 text-sm font-medium">
                    ...
                    {props.from === 'show' && (
                        <>
                            ...
                            <Link href={route('admin.canteens.show', kantin.id)} className="text-[#3852b4] hover:underline">
                                Detail
                            </Link>
                        </>
                    )}
        ...
        >
            ...
            <div className="p-6 lg:p-8 font-sans pb-20 w-full">
                {/* Form Container */}
                <div className="max-w-5xl mx-auto w-full bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden relative">
