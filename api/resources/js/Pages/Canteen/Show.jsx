    ...
    return (
        <AdminLayout title="Detail Kantin" description={
            <div className="flex items-center gap-2 text-sm font-medium">
                <Link href={route('admin.canteens.index')} className="text-[#3852b4] hover:underline">Daftar Kantin</Link>
                <span className="text-gray-400">›</span>
                <span className="text-gray-500">Detail</span>
            </div>
        } rightContent={
            <div className="flex items-center gap-3">
                <Link href={route('admin.canteens.edit', { id: kantin.id, from: 'show' })} className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#3852b4] hover:bg-[#2c4190] text-white text-sm font-semibold rounded-xl transition-all">
