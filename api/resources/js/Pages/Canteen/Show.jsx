...
export default function Show({ kantin, total_penjualan, total_menu_terjual, menus, sales_activity }) {
    ...
    const handleDelete = () => { if (window.confirm('Apakah Anda yakin ingin menghapus kantin ini?')) { router.delete(route('admin.canteens.destroy', kantin.id), { onSuccess: () => router.visit(route('admin.canteens.index')) }) } };
    ...
    return (
        <AdminLayout title="Detail Kantin" description={
            ...
            <div className="flex items-center gap-3">
                ...
                <button onClick={handleDelete} className="inline-flex items-center gap-2 px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold rounded-xl transition-all">
